...
const ScrollUpButton = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      id="scroll-up"
      className={`fixed bottom-4 right-4 p-3 bg-black rounded-xl shadow-[0px_0px_7px_5px_#87A08E] text-white transition-all ${isVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
